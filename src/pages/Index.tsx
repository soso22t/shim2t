...
const Index = () => {
  ...
  // التمرير التلقائي الثابت والبطيء من البداية للنهاية بدون أي تسارع
  useEffect(() => {
    if (!opened) return;
    ...
    // سرعة ثابتة ومستقرة تماماً بكسل لكل إطار دون أي تسارع
      ...
      >
        ...
        <section className="relative w-full flex flex-col items-center justify-start pb-12">
          ...
          <div className="relative z-10 w-full flex flex-col items-center pt-20 sm:pt-32 px-4 space-y-6">
            <Reveal width="100%">
              <div
                className="w-[92%] max-w-md mx-auto p-5 sm:p-7 rounded-3xl text-center backdrop-blur-md border border-white/50 shadow-2xl space-y-2.5 animate-pulse"
        ...
        <section id="gallery" className="relative w-full flex flex-col items-center justify-start">
          <div className="relative w-full flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center px-4 py-6">
              ...
              <Reveal width="100%">
                <div className="w-[92%] max-w-md mx-auto rounded-3xl overflow-hidden backdrop-blur-md border border-white/40 shadow-xl mb-6">
                  <img
                    src={cardImg}
                    alt="بطاقة تذكارية"
