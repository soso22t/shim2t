...
const Index = () => {
  ...
  useEffect(() => {
    ...
    // ضبط سرعة ثابتة ومستقرة تماماً (بكسل في كل إطار) دون أي تسارع أو تباطؤ
      ...
      >
        ...
        <section className="relative w-full flex flex-col items-center justify-start pb-12">
          ...
          <div className="relative z-10 w-full flex flex-col items-center pt-20 sm:pt-32 px-4 space-y-6">
            <Reveal width="100%">
              <div
                className="w-[92%] max-w-md mx-auto p-5 sm:p-7 rounded-3xl text-center backdrop-blur-md border border-white/50 shadow-2xl space-y-2.5"
